...
public class GetDoneUserTrainingsAction implements InterfaceAction {

    private RuntimeProfile profile;
    private InterfaceTrainingService trainingService;
    
    public GetDoneUserTrainingsAction(RuntimeProfile profile, InterfaceTrainingService trainingService) {
    ...
    public void perform() {
        ...
        try {
            ...
            Training[] trainings = trainingService.getDoneTrainingsByUserID(userId, userId);
