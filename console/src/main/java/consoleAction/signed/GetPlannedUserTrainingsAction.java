...
public class GetPlannedUserTrainingsAction implements InterfaceAction {
    
    private RuntimeProfile profile;
    private InterfaceTrainingService trainingService;
    
    public GetPlannedUserTrainingsAction(RuntimeProfile profile, InterfaceTrainingService trainingService) {
    ...
    public void perform() {
        ...
        try {
            ...
            Training[] trainings = trainingService.getPlannedTrainingsByUserID(userId, userId);
